...
const getNavigation = (t: (key: string) => string) => [
  { name: t("newJournal"), href: "/app/journal", icon: PlusCircle },
  { name: t("dashboard"), href: "/app/dashboard", icon: LayoutDashboard },
  { name: t("planner"), href: "/app/planner", icon: CalendarDays },
  { name: t("tasks"), href: "/app/tasks", icon: ListChecks },
  // { name: t("routines"), href: "/app/routines", icon: Clock },
  { name: t("myJournals"), href: "/app/journals", icon: BookOpen },
  // { name: t("profile"), href: "/app/profile", icon: User },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-neutral-200 dark:border-neutral-800">
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
            >
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-linear-to-br from-primary-500 to-secondary-500 flex items-center justify-center text-white font-bold text-sm sm:text-base shadow-sm">
                H
              </div>
          ...
          {/* Navigation - Espacement optimisé */}
          ...
          <div className="px-3 sm:px-4 py-3 sm:py-4 border-t border-neutral-200 dark:border-neutral-800 space-y-3">
            ...
            {user && (
              <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2 rounded-lg bg-neutral-50 dark:bg-neutral-800/50">
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-linear-to-br from-primary-500 to-secondary-500 flex items-center justify-center text-white font-semibold text-xs sm:text-sm shadow-sm shrink-0">
                  {getUserInitials()}
                </div>
